  ...
  return (
    <footer className="site-footer">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
        ...
        <div>
          <h4 className="text-sm font-semibold">Get weekly resume tips</h4>
          <p className="mt-3 text-sm text-muted-foreground">No spam. Unsubscribe anytime.</p>
          <form
          ...
          >
            <Input
              ...
              className="h-9 rounded-full bg-background/60"
            />
            <Button type="submit" size="sm" variant="hero" className="rounded-full px-4">
              Join
            </Button>
          </form>
        </div>
