        ...
        <CardContent className="p-6">
          ...
          <div className="mt-4">
            {isLocked ? (
              <div className="flex flex-wrap gap-1.5">
                <span
                  className="rounded-full bg-warning/10 px-3 py-1 text-xs font-medium text-warning flex items-center gap-1"
                >
                  <Lock className="w-3 h-3" />
                  {missingKeywords.length} Missing Keywords Found
                </span>
              </div>
          ...
          <div className="mt-3 flex flex-wrap gap-1.5">
            {isLocked ? (
              <div className="flex flex-wrap gap-1.5">
                <span
                  className="rounded-full bg-success/10 px-3 py-1 text-xs font-medium text-success flex items-center gap-1"
                >
                  <Lock className="w-3 h-3" />
                  {presentKeywords.length} Keywords Detected
                </span>
              </div>
