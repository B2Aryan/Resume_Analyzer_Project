...
export const Route = createFileRoute("/data-analyst-resume-template")({
  head: () =>
    createSeoHead({
      title: "Data Analyst Resume Template",
      description: "Get a free, ATS-optimized data analyst resume template to stand out to recruiters and hiring managers.",
  ...
  component: DataAnalystResumeTemplatePage,
});

function DataAnalystResumeTemplatePage() {
  return (
    <MarketingLayout>
      <section className="hero-ambient py-20 sm:py-32">
        <div className="mx-auto max-w-4xl px-5 sm:px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Get a free, ATS-optimized data analyst resume template and check its compatibility with our tool.
          </p>
          <div className="mt-8">
