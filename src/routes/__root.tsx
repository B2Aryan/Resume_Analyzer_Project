...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ResumeCheck AI — Instant ATS Resume Analyzer for Students" },
      ...
      { property: "og:title", content: "ResumeCheck AI — Instant ATS Resume Analyzer for Students" },
      ...
      { name: "twitter:title", content: "ResumeCheck AI — Instant ATS Resume Analyzer for Students" },
